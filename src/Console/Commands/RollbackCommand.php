...
class RollbackCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'diviky:rollback:subscriptions {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Rollback Diviky Subscriptions Tables.';
